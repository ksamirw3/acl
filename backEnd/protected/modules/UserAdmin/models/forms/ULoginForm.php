...
class ULoginForm extends CFormModel
{
        ...
        {
                return array(
                        array('login', 'required', 'message' => Yii::t('UserAdminModule.LoginForm', 'emptyLogin')),
                        array('password', 'required', 'message' => Yii::t('UserAdminModule.LoginForm', 'emptyPassword')),
        ...
        public function attributeLabels()
        {
                return array(
                        ...
                        'loginBtu'      => Yii::t("UserAdminModule.LoginForm","LoginBtu"),
                );
        }
